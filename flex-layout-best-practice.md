...
这里的 notes1 中的**old flexbox**指的是2009年的版本`display: -webkit-box`，notes2 指的是2011年的 `display: flexbox` 版本
...
android、ios、其它webkit系浏览器。他们都**支持2009版本带前缀**，以及**2012版本**。

我们使用2009年版本就够了（见**附属性向前兼容**）：**且只需要写**`display: -webkit-box`**（不带前缀的感觉没必要写）**
